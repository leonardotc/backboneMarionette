...
(function(factory) {
  ...
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(8), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
(function (global, factory) {
	 true ? module.exports = factory(__webpack_require__(0), __webpack_require__(2), __webpack_require__(9)) :
...
"use strict";
const Routes = {
  videoPath: () => '/api/videos/youtube',
  videosChannelPath: () => '/api/videos/youtube/channel'
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_routes__ = __webpack_require__(3);



const Video = __WEBPACK_IMPORTED_MODULE_0_backbone__["Model"].extend({
  urlRoot: __WEBPACK_IMPORTED_MODULE_1__config_routes__["a" /* default */].videosPath,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__router_index_js__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config_routes__ = __webpack_require__(3);





const App = new __WEBPACK_IMPORTED_MODULE_1_backbone_marionette__["Application"]({

  onStart(options) {
    this.router = new __WEBPACK_IMPORTED_MODULE_0__router_index_js__["a" /* default */]({
      app: this
    });
    __WEBPACK_IMPORTED_MODULE_2_backbone__["history"].start();
  }

});

App.start({ routes: __WEBPACK_IMPORTED_MODULE_3__config_routes__["a" /* default */] }); //fire this after loaded defaults from the backend
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__controller_js__ = __webpack_require__(10);



const Router = __WEBPACK_IMPORTED_MODULE_0_backbone_marionette__["AppRouter"].extend({
  controller: new __WEBPACK_IMPORTED_MODULE_1__controller_js__["a" /* default */](),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_backbone_marionette__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_backbone_marionette___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_backbone_marionette__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_video__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__collections_videos__ = __webpack_require__(11);




const Controller = __WEBPACK_IMPORTED_MODULE_0_backbone_marionette__["Object"].extend({

  showRoot() {
    console.log("test it");
  },
  showVideo(id) {
    const video = new __WEBPACK_IMPORTED_MODULE_1__models_video__["a" /* default */]({ id: '2LtGZJvbjTQ' });
    video.fetch().then(content => console.log(video));
  },
  showVideos(channelId) {
    const videos = new __WEBPACK_IMPORTED_MODULE_2__collections_videos__["a" /* default */]({ id: 'UCWRbcEYuQc1Jcl3Wyu6f9sw' });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_backbone___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_backbone__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_video__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config_routes__ = __webpack_require__(3);




const Videos = __WEBPACK_IMPORTED_MODULE_0_backbone__["Collection"].extend({
  model: __WEBPACK_IMPORTED_MODULE_1__models_video__["a" /* default */],
  url: __WEBPACK_IMPORTED_MODULE_2__config_routes__["a" /* default */].videosChannelPath,
  initialize(options) {
